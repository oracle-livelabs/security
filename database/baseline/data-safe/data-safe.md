...
9. Now, let's active it
    ...
    - Click [**Download install Bundle**] to download the zip file onto your local machine and enter a password (here *`Oracle1234567!`*)

        ````
        <copy>Oracle1234567!</copy>
        ````
    ...
    - Setup the Data Safe On-Premises connector
        ...
        - Install Data Safe On-Premises connector (enter the password defined for the zip file above - here *`Oracle1234567!`*)
