...
| 6        | Create the OKV SEPS Wallet                        | <5 minutes   |                                                                            |
| 7        | Perform a ReKey Operation                         | 5 minutes    |                                                                            |
| 8        | Encrypt an existing tablespace online             | 5 minutes    | Perform an online tablespace encryption of `EMPLOYEESEARCH_DATA`           |
</if>
...
## Task 8: Encrypt an existing tablespace
...
6. Exit SQL\*Plus and run the command to look at the now that the tablespace is encrypted.
	...
	Note: You should not see any data now. 

6. Congratulations, now you know how to encrypt a tablespace with zero downtime. 
