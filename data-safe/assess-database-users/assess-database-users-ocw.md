...
3. On the **Target summary** tab, select the name of the latest user assessment for your target database.

    The latest security assessment opens.

4. On the **Overview** tab, review the charts.
...
5. Select the **Assessment Information** tab and review the details.

    ![User Assessment Details tab](images/ua-assessment-details-tab.png "User Assessment Details tab")

6. To rename the latest user assessment: From the **Actions** menu, select **Edit display name**. Enter **UA_target-database_LATEST** (replace **target-database** with the name of your target database), and select **Update**.

    ![Rename latest user assessment](images/rename-latest-ua-assessment.png "Rename latest user assessment")

7. Select the **Assessment details** tab and review the following information in the table:
