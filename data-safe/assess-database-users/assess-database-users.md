...
1. On the left, navigate to the **User assessment** landing page.
...
2. Select  the **Assessment details** tab and review the details.
...
5. Review the following information in the table:
...
6. Locate a line in the table for a user that is considered a **CRITICAL** potential risk, for example, **EVIL_RICH**. At the end of the row, select the three dots, and then select **View roles and privileges**. The **User details** panel opens.
...
8. To filter the report to show potentially critical risk users only, do the following: Select the **Search and Filter** box, and then select **Potential risk**. Enter **critical** and select **Apply Filter**.
...
2. Select your compartment, and then select the initial assessment for your target database. As soon as you select it, the comparison operation is started. If an existing comparison exists, it is immediately displayed. Because this is your first time, select **Compare**.
...
7. Review the information, and then select **Close**. At this point, you might consider setting a baseline assessment.
