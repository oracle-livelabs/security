...
8. To filter the report to show potentially critical risk users only: Select the **Search and Filter** box, and then select **Potential risk**. Enter **critical**, and then select **Apply filter**.
