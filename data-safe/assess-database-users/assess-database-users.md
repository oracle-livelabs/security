...
4. Select the **Assessment details** tab and review the following information in the table:
...
5. Locate a **CRITICAL** potential risk user, for example, **EVIL_RICH**. At the end of the row, select the three dots, and then select **View roles and privileges**. The **User details** panel opens.
...
7. To filter the report to show potentially critical risk users only: Select the **Search and Filter** box, and then select **Potential risk**. Enter **critical**, and then select **Apply filter**.

    The table is adjusted.

    ![Critical risk users filter](images/ua-critical-risk-users-filter.png "Critical risk users filter")

8. To remove the filter, select the **X** next to the filter.
