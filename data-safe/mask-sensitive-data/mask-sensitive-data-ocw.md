...
2. Clear the worksheet and script output.
...
6. Configure the masking policy as follows:
    ...
    - Sensitive Data Model: Select **SDM1**. If you don't have this sensitive data model, see the [Discover Sensitive Data](?lab=discover-sensitive-data-ocw) lab.
...
2. Click the pencil button next to the masking format to open the **Edit Masking Format** page. 
...
6. To save your update, click **Save Masking Formats**. 
