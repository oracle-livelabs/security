...
1. On the left, navigate to the landing page for **Data discovery**.
...
5. For **Step 3 - Select tables for schemas** page, leave **All tables** selected, and select **Next**.

    ![Select tables for schema page](images/select-tables-for-selected-schemas.png "Select tables for schema page")
    
6. For **Step 4 - Select sensitive types**, review the common sensitive types. From the dropdown list, select **All sensitive types** and review them. Switch back to common sensitive types and select them all by selecting the **Sensitive Type** check box. Select **Next**.

    ![Select all common sensitive types](images/select-all-common-sensitive-types.png "Select all common sensitive types")

7. For **Step 5 - Select discovery options** page, select **Collect, display, and store sample data**, and then select **Create sensitive data model** to begin the data discovery process.

    ![Select discovery options page](images/select-discovery-options-page.png "Select discovery options")

8. Wait for the sensitive data model to be created. The **Sensitive data model details** page opens.
...
2. From the **Actions** menu, select **Run discovery now**.
...
6. For **Step 3 - Select tables for selected schemas**, select **Next**.
...
11. From the **Actions** menu, select **Manage results**. The **Incremental discovery** panel opens. Here you can approve and reject incremental discovery results or specific results.

12. Select **All incremental discovery results**, and then select **Approve**. The **Approve discvoery results** dialog box opens.

    ![Approve all incremental discovery results](images/approve-discovery-results.png "Approve all incremental discovery results")

13. Select **Approve**. Notice that the **Planned action** column now has **Approved** listed in each row.
...
14. From the **Actions** menu, select **Manage results**. Select **Apply to SDM**.
...
14. Click **Apply to sensitive data model** and wait to be returned to the **Incremental discovery** tab.

    The sensitive data model is updated with the additional sensitive columns and you are returned to the **Incremental discovery** tab. There are no sensitive columns listed anymore because you added them to the sensitive data model.
...
2. From the **Actions** menu, select **Remove columns**. 
...
1. From the **Actions** menu, select **Add columns**.
...
7. From the **Sensitive type** drop-down list, select **Address Country**. *Be sure to select Country, not County.*

8. Select **Add columns** and wait until you are returned to the **Sensitive columns** list.
...
- **Last Updated By/Date** - Jody Glover, January 21, 2026
