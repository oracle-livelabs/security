...
1. From the navigation menu, select **Oracle AI Database**, and then **Data Safe - Database Security**. The **Overview** page titled **Simplify security for your Oracle databases** opens. If the **Welcome to Data Safe** tour dialog box is displayed, click **Stop tour**.

2. On the left, expand **Data Safe - Database Security**, and then select **Target databases**. The **Target databases** page opens. 

3. Next to **Applied filters**, select the compartment that contains your target database. Your registered target database is listed in the table.
